...
from svm_models import SVM_linear
...
# Split the data and labels into training and testing sets for each class
...
# Combine the training data and labels from all classes
x_train = np.vstack(
    (
        drying_x_train,
        normal_x_train,
...
# Combine the testing data and labels from all classes
x_test = np.vstack(
    (
        drying_x_test,
        normal_x_test,
...
# Create an instance of the SVM_linear model
clf = SVM_linear()
